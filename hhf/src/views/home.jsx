        ...
        <div className="main-card">
          <div className="card-txt">
            ...
            <h3 className="text-body1">
              ...
              <br />
              dolore eius ex, dignissimos cupiditate in eos quod magni quas
              natus praesentium hic, obcaecati veritatis quos fugit autem
              doloremque, aut aliquid.
            </h3>
            <Link to="/Product">
      ...
      <section className="section">
        <div className="Welcome">
          ...
          <div className="homepage_card">
            ...
            <p>
              At HARNIXHERBTY FARMS LIMITED, we're passionate about good
              products, exceptional service and positive team spirit. We
              understand how valuable your time is, which is why we will leave
              no stone unturned in order to find the right solution for you.
            </p>
            <p>
              Read about our selection of products and services below, and
